  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-[#f8fafc] p-6 font-['Inter'] relative overflow-hidden">
      ...
      <button 
        ...
        className="absolute top-8 left-8 flex items-center gap-2 text-gray-400 hover:text-[#003d3d] transition-colors font-bold text-xs uppercase tracking-widest group z-10"
      >
        <svg 
